...
CREATE TABLE `alarm` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=239507 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `alarm_history` (
  ...
  KEY `idx_level` (`level`)
) ENGINE=InnoDB AUTO_INCREMENT=544374 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `alarm_temp` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=239318 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `backup` (
  ...
  `ipaddress` varchar(30) CHARACTER SET utf8 DEFAULT '0.0.0.0',
  ...
  `database_name` varchar(20) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `frequency_name` varchar(20) CHARACTER SET utf8 NOT NULL DEFAULT 'DAILY',
...
--
-- Table structure for table `db_servers_memcache`
--

DROP TABLE IF EXISTS `db_servers_memcache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `db_servers_memcache` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `db_servers_mongodb` (
  ...
  `port` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `db_servers_mysql` (
  ...
  `monitor_proxy` varchar(30) DEFAULT '0',
  `send_mail` tinyint(2) DEFAULT '1',
  `send_mail_to_list` varchar(255) DEFAULT NULL,
  `send_mail_to_dev` varchar(1000) DEFAULT NULL COMMENT 'active sql 发送开发人员列表',
  `send_sms` tinyint(2) DEFAULT '0',
  `send_sms_to_list` varchar(255) DEFAULT NULL,
  ...
  `slow_query_time` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE `db_servers_redis` (
  ...
  `display_order` smallint(4) NOT NULL DEFAULT '0',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `alarm_used_memory` tinyint(2) NOT NULL DEFAULT '1',
  `threshold_warning_used_memory` bigint(20) unsigned NOT NULL DEFAULT '1000' COMMENT '单位MB',
...
--
-- Table structure for table `db_servers_sqlserver`
--
...
--
-- Table structure for table `memcache_status`
--

DROP TABLE IF EXISTS `memcache_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `memcache_status` (
  ...
  `tags` varchar(50) DEFAULT NULL,
  `connect` smallint(4) NOT NULL DEFAULT '-1',
  `pid` int(10) NOT NULL DEFAULT '-1',
  `total_items` bigint(10) DEFAULT '-1',
  `uptime` int(10) NOT NULL DEFAULT '-1',
  `version` varchar(30) NOT NULL DEFAULT '',
  `limit_maxbytes` bigint(20) NOT NULL DEFAULT '-1',
  `rusage_user` varchar(30) NOT NULL DEFAULT '-1.00',
  `bytes_read` bigint(20) NOT NULL DEFAULT '-1',
  `rusage_system` varchar(30) NOT NULL DEFAULT '-1.00',
  `cmd_get` bigint(20) NOT NULL DEFAULT '-1',
  `curr_connections` int(10) NOT NULL DEFAULT '-1',
  `threads` int(10) NOT NULL DEFAULT '-1',
  `total_connections` int(10) NOT NULL DEFAULT '-1',
  `cmd_set` bigint(10) DEFAULT '-1',
  `curr_items` int(10) NOT NULL DEFAULT '-1',
  `get_misses` int(10) NOT NULL DEFAULT '-1',
  `evictions` int(10) NOT NULL DEFAULT '-1',
  `bytes` int(10) NOT NULL DEFAULT '-1',
  `connection_structures` int(10) NOT NULL DEFAULT '-1',
  `bytes_written` bigint(20) NOT NULL DEFAULT '-1',
  `time` int(10) NOT NULL DEFAULT '-1',
  `pointer_size` int(10) NOT NULL DEFAULT '-1',
  `get_hits` bigint(20) NOT NULL DEFAULT '-1',
  `network_bytesIn_persecond` int(10) NOT NULL DEFAULT '-1',
  `network_bytesOut_persecond` int(10) NOT NULL DEFAULT '-1',
  `opcounters_get_persecond` int(10) NOT NULL DEFAULT '-1',
...
) ENGINE=InnoDB AUTO_INCREMENT=138714 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `memcache_status_history`
--

DROP TABLE IF EXISTS `memcache_status_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=138713 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mongodb_current_op`
--

DROP TABLE IF EXISTS `mongodb_current_op`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mongodb_current_op` (
  ...
  `Op_insert` varchar(1000) DEFAULT NULL,
  `Client` varchar(256) DEFAULT NULL,
  `Msg` varchar(256) DEFAULT NULL,
  `Locks` varchar(256) DEFAULT NULL,
  `WaitingForLock` tinyint(3) unsigned DEFAULT NULL,
  `LockStats` varchar(1000) DEFAULT NULL,
  `uuid` varchar(100) DEFAULT NULL,
  `CreateTime` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=249901 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mongodb_current_op_his`
--

DROP TABLE IF EXISTS `mongodb_current_op_his`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mongodb_current_op_his` (
  `Id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `host` varchar(30) DEFAULT NULL,
  `port` varchar(10) DEFAULT NULL,
  `Op_desc` varchar(256) DEFAULT NULL,
  ...
  `CreateTime` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=764108 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1163470 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mysql_connected` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=86243459 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=872192 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mysql_processlist_alarm`
--

DROP TABLE IF EXISTS `mysql_processlist_alarm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mysql_processlist_alarm` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) DEFAULT NULL,
  `host` varchar(30) NOT NULL,
  `port` varchar(10) NOT NULL,
...
--
-- Table structure for table `mysql_processlist_history`
--

DROP TABLE IF EXISTS `mysql_processlist_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mysql_processlist_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) DEFAULT NULL,
  `host` varchar(30) NOT NULL,
  `port` varchar(10) NOT NULL,
  ...
  KEY `idx_server_id` (`server_id`) USING BTREE,
  KEY `idx_application_id` (`tags`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2024771 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28480825 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28480816 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mysql_replication_history_bak`
--

DROP TABLE IF EXISTS `mysql_replication_history_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mysql_replication_history_bak` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) NOT NULL,
  `tags` varchar(50) NOT NULL DEFAULT '',
  `host` varchar(30) DEFAULT NULL,
...
--
-- Table structure for table `mysql_slow_query_review_history_history`
--

DROP TABLE IF EXISTS `mysql_slow_query_review_history_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mysql_slow_query_review_history_history` (
  `serverid_max` smallint(4) NOT NULL DEFAULT '0',
  `db_max` varchar(100) DEFAULT NULL,
  `user_max` varchar(100) DEFAULT NULL,
  `checksum` bigint(20) unsigned NOT NULL,
...
CREATE TABLE `mysql_status` (
  ...
  `threads_waits` int(10) DEFAULT '-1',
  ...
  KEY `idx_server_id` (`server_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=35685332 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mysql_status_history` (
  ...
  KEY `idx_create_time` (`create_time`) USING BTREE,
  KEY `idx_yhdmi` (`YmdHi`)
) ENGINE=InnoDB AUTO_INCREMENT=35685317 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `os_status_bak`
--

DROP TABLE IF EXISTS `os_status_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `os_status_bak` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `ip` varchar(50) NOT NULL,
  `snmp` tinyint(2) NOT NULL DEFAULT '0',
  `tags` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `os_status_history_bak`
--

DROP TABLE IF EXISTS `os_status_history_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `os_status_history_bak` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `ip` varchar(50) NOT NULL,
  `snmp` tinyint(2) NOT NULL DEFAULT '0',
  `tags` varchar(100) DEFAULT NULL,
...
CREATE TABLE `redis_replication` (
  ...
  `master_server_id` smallint(4) NOT NULL DEFAULT '-1',
  ...
  `repl_backlog_active` varchar(25) DEFAULT '0',
  `repl_backlog_size` varchar(25) DEFAULT '0',
  `repl_backlog_first_byte_offset` varchar(25) DEFAULT '0',
  `repl_backlog_histlen` varchar(25) DEFAULT '0',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uni_server_id` (`server_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6886587 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `redis_replication_history` (
  ...
  `ymdhi` bigint(18) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6886578 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `redis_status` (
  ...
  `client_longest_output_list` int(11) NOT NULL DEFAULT '-1',
  `client_biggest_input_buf` int(11) NOT NULL DEFAULT '-1',
  ...
  `rdb_changes_since_last_save` bigint(18) DEFAULT '-1',
  ...
  `total_connections_received` int(10) NOT NULL DEFAULT '-1',
  `total_commands_processed` bigint(18) DEFAULT '-1',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uni_server_id` (`server_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6789447 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `redis_status_history` (
  ...
  KEY `idx_server_ymdhi` (`server_id`,`ymdhi`)
) ENGINE=InnoDB AUTO_INCREMENT=6789438 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sqlserver_status`
--
...
--
-- Table structure for table `sqlserver_status_history`
--
...
-- Dump completed on 2016-12-23 10:33:00
