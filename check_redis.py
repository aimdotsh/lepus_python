...
def check_redis(host,port,passwd,server_id,tags):
    try:
        r=redis.StrictRedis(host=host,port=int(port),password=passwd,db=0,socket_timeout=3,encoding='utf-8') 
        info=r.info()
        time.sleep(1)
        info_2=r.info()
        # Server
        ...
        # replication
        repl_backlog_active = check_value(info,'repl_backlog_active')
        repl_backlog_size =  check_value(info,'repl_backlog_size')
        repl_backlog_first_byte_offset  =  check_value(info,'repl_backlog_first_byte_offset')
        repl_backlog_histlen = check_value(info,'repl_backlog_histlen')
        ...
        sql_1 = "replace into redis_replication(server_id,tags,host,port,role,master_server_id,master_host,master_port,master_link_status,master_last_io_seconds_ago,master_sync_in_progress,slave_priority,slave_read_only,connected_slaves,repl_backlog_active,repl_backlog_size,repl_backlog_first_byte_offset,repl_backlog_histlen) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s );"
        param_1 = (server_id,tags,host,port,role,master_server_id,master_host,master_port,master_link_status,master_last_io_seconds_ago,master_sync_in_progress,slave_priority,slave_read_only,connected_slaves,repl_backlog_active,repl_backlog_size,repl_backlog_first_byte_offset,repl_backlog_histlen)
